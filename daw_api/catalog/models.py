...
class Movie(models.Model):
    ...
    description = models.TextField(max_length=1000, help_text='Enter a brief description of the movie', null=True, blank=True)
    ...
    def get_absolute_url(self):
        ...
        Returns the url to access a particular author instance.
        """
        return reverse('movie-detail', args=[str(self.name)])
